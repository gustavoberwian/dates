var styleSwitcher = {
    ...
    initialize: function() {
        ...
        this.initialized || (r.options = $.extend({}, r.defaults),
            ...
            ,
        null != $.cookie("borderRadius") && (r.options.borderRadius = $.cookie("borderRadius")),
        null != $.cookie("colorPrimary") && (r.options.colorPrimary = "#" + $.cookie("colorPrimary")),
        null != $.cookie("colorSecondary") && (r.options.colorSecondary = "#" + $.cookie("colorSecondary")),
        null != $.cookie("colorTertiary") && (r.options.colorTertiary = "#" + $.cookie("colorTertiary")),
        null != $.cookie("colorQuaternary") && (r.options.colorQuaternary = "#" + $.cookie("colorQuaternary")),
        t && (t = t.replace(/'/g, '"'),
            ...
            $("head").append($('<link rel="stylesheet/less">').attr("href", "master/less/extension.less")),
            $("head").append($('<link rel="stylesheet">').attr("href", "master/style-switcher/bootstrap-colorpicker/css/bootstrap-colorpicker.css")),
            $.styleSwitcherCachedScript("master/style-switcher/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js").done(function(o, e) {
                less = {
                    async: !0,
                    env: "production",
                    modifyVars: {
                    ...
                    $.styleSwitcherCachedScript("master/less/less.js").done(function(o, e) {
                        $.ajax({
                            ...
                            $("body").append(o),
                                ...
                                r.build(),
                                r.events(),
                            t || (null != $.cookie("layoutStyle") && (r.options.layoutStyle = $.cookie("layoutStyle")),
                            null != $.cookie("backgroundColor") && (r.options.backgroundColor = $.cookie("backgroundColor")),
                            null != $.cookie("headerColor") && (r.options.headerColor = $.cookie("headerColor")),
                            null != $.cookie("sidebarColor") && (r.options.sidebarColor = $.cookie("sidebarColor")),
                            null != $.cookie("sidebarSize") && (r.options.sidebarSize = $.cookie("sidebarSize"))),
                                r.setLayoutStyle(r.options.layoutStyle),
                                r.setBackgroundColor(r.options.backgroundColor),
                            ...
                            null == $.cookie("initialized") && (r.container.find("#styleSwitcherOpen").trigger("click"),
                                $.cookie("initialized", !0)),
                                r.initialized = !0
                        })
                    })
            }),
            $.styleSwitcherCachedScript("master/style-switcher/cssbeautify/cssbeautify.js").done(function(o, e) {}))
    },
    build: function() {
        var e = this
        ...
        colorSecondaryField = e.container.find(".color-secondary input"),
            ...
            colorQuaternaryField = e.container.find(".color-quaternary input"),
            r.val(e.options.colorPrimary).parent().colorpicker({
                align: "right",
                customClass: "style-switcher-color-picker"
            }),
            colorSecondaryField.val(e.options.colorSecondary).parent().colorpicker(),
            colorTertiaryField.val(e.options.colorTertiary).parent().colorpicker(),
            colorQuaternaryField.val(e.options.colorQuaternary).parent().colorpicker(),
            $(".colorpicker").on("mousedown", function(o) {
                o.preventDefault(),
                    e.isChanging = !0
    ...
    events: function() {
        ...
        $("#styleSwitcherOpen").click(function(o) {
            o.preventDefault(),
                e.container.hasClass("active") ? e.container.animate({
    ...
    setColors: function(o, e) {
        ...
        if (this.isChanging)
            return !1;
        o && (r.options["color" + e.capitalize()] = o,
            r.container.find(".color-" + e + " input").val(o)),
        r.options.preserveCookies || ($.cookie("colorPrimary", r.options.colorPrimary.replace("#", "")),
            $.cookie("colorSecondary", r.options.colorSecondary.replace("#", "")),
            $.cookie("colorTertiary", r.options.colorTertiary.replace("#", "")),
            $.cookie("colorQuaternary", r.options.colorQuaternary.replace("#", ""))),
            r.modifyVars(),
            this.setLogo()
    },
    setBorderRadius: function(o) {
        ...
        e.find(".active").removeClass("active"),
            e.find("a[data-border-radius=" + o + "]").addClass("active"),
            $.event.trigger({
    ...
    setBackgroundColor: function(o) {
        ...
        this.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("backgroundColor", o);
        var e = this.container.find(".options-links.background-color");
        e.find(".active").removeClass("active"),
            e.find("a[data-background-color=" + o + "]").addClass("active"),
            "dark" == o ? ($("html").addClass("dark"),
                $("#addDarkClassInfo").show()) : ($("html").removeClass("dark"),
    ...
    setHeaderColor: function(o) {
        ...
        this.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("headerColor", o);
        var e = this.container.find(".options-links.header-color");
        e.find(".active").removeClass("active"),
            e.find("a[data-header-color=" + o + "]").addClass("active"),
            "dark" == o ? ($("html").addClass("header-dark"),
                $("#addHeaderDarkClassInfo").show()) : ($("html").removeClass("header-dark"),
    ...
    setSidebarColor: function(o) {
        ...
        this.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("sidebarColor", o);
        var e = this.container.find(".options-links.sidebar-color");
        e.find(".active").removeClass("active"),
            e.find("a[data-sidebar-color=" + o + "]").addClass("active"),
            "light" == o ? ($("html").addClass("sidebar-light"),
                $("#addSidebarLightClassInfo").show()) : ($("html").removeClass("sidebar-light"),
    ...
    setLayoutStyle: function(o, e) {
        if (this.options.preserveCookies || $.cookie("layoutStyle", o),
        this.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("layout", o),
            e)
        ...
        e.find(".active").removeClass("active"),
            e.find("a[data-layout-type=" + o + "]").addClass("active"),
            "wide" == o ? ($("html").removeClass("boxed"),
                $("#addBoxedClassInfo").hide()) : ($("html").addClass("boxed").removeClass("fixed"),
    ...
    setSidebarSize: function(o) {
        ...
        this.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("sidebarSize", o);
        var r = this.container.find(".options-links.sidebar-size");
        switch (r.find(".active").removeClass("active"),
    ...
    setLogo: function(o) {
        ...
        o || ("#" + $.cookie("colorPrimary")).toUpperCase() == this.defaults.colorPrimary.toUpperCase() && "dark" != $.cookie("backgroundColor") ? e.attr("src", "img/logo-default.png") : "dark" == $.cookie("backgroundColor") || "dark" == $.cookie("headerColor") ? e.attr("src", "img/logo-light.png") : e.attr("src", "img/logo.png"),
            $.event.trigger({
    ...
    modifyVars: function() {
        ...
        window.clearTimeout(o.timer),
            o.timer = window.setTimeout(function() {
                ...
                o.options.saveToStorage && "undefined" != typeof localStorage && localStorage.setItem("skin-admin.css", $('style[id^="less:"]').text()),
                    $.event.trigger({
    ...
    reset: function() {
        $.removeCookie("borderRadius"),
            ...
            window.location.reload(),
        "undefined" != typeof localStorage && (localStorage.removeItem("skin-admin.css"),
    ...
    getCss: function() {
        ...
        $("#getCSSTextarea").text($('style[id$="less-skin"]').text()).focus(function() {
            ...
            o.select(),
                o.mouseup(function() {
                    return o.unbind("mouseup"),
                        !1
                })
        }),
            o = $("#getCSSTextarea").text(),
            $("#getCSSTextarea").text(cssbeautify(o, {
                indent: "\t",
                autosemicolon: !0
            })),
            ...
            $("#getCSSTextareaExtension").text(cssbeautify(e, {
                indent: "\t",
                autosemicolon: !0
            })),
